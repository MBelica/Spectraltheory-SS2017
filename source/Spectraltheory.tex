...
\begin{lemma}
	...
	\end{proof}
\end{lemma} % todo page 13!??!? skipped that completely
...
\begin{example} ~\
	\begin{enumerate} 
		...
		\item Schrödinger operator with a Coulomb potential ~\\
			...
			satisfies the assumptions of the Friedrichs extension. Completion $V$ of $C_c^{\infty}$ in $L^2$ with respect to the norm % todo is it really a 2
